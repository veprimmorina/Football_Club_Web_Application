...
function LogIn() {
    const [showFjalkalimi, setShowFjalkalimi]=useState(false);
    function login(){
            ...
            <div class="card p-3">
                ...
                <form onsubmit="event.preventDefault()" class="form-card">
                    ...
                    <div class="row justify-content-center text-center">
                        <div class="col-12">
                            <div class="input-group"> <input type="text" name="Name" id="emP" placeholder=""/> <label>Emri i Perdoruesit</label> </div>
                        </div>
                    </div>
                    <div class="row justify-content-center text-center">
                        <div class="col-12">
                            <div class="input-group"> <input type="password" id="fja" name="card-no" placeholder=""/> <label>Fjalkalimi</label> </div>
                        </div>
                    </div>
                    {
                     showFjalkalimi && <input type="password" />
                    }
                    </div>
